...
_tester4:     file format elf32-i386
...
int *test = (int *)malloc(4096 * 8000);
  ...
  12:	68 00 00 f4 01       	push   $0x1f40000
...
printf(1, "%d\n", test);
  21:	50                   	push   %eax
  22:	68 50 07 00 00       	push   $0x750
  27:	6a 01                	push   $0x1
  29:	e8 02 04 00 00       	call   430 <printf>
printf(1,"displaying memory before fork()");
  2e:	58                   	pop    %eax
  2f:	5a                   	pop    %edx
  30:	68 60 07 00 00       	push   $0x760
  35:	6a 01                	push   $0x1
  37:	e8 f4 03 00 00       	call   430 <printf>
myMemory();
  3c:	e8 41 03 00 00       	call   382 <myMemory>
if (fork()==0)
  41:	e8 94 02 00 00       	call   2da <fork>
  ...
  4b:	75 37                	jne    84 <main+0x84>
{
  ...
  50:	68 00 00 f4 01       	push   $0x1f40000
  55:	e8 06 06 00 00       	call   660 <malloc>
    printf(1,"displaying memory allocation in child");
  5a:	5a                   	pop    %edx
  5b:	59                   	pop    %ecx
  5c:	68 80 07 00 00       	push   $0x780
printf(1, "%d\n", test);
printf(1,"displaying memory before fork()");
myMemory();
if (fork()==0)
{
  ...
  65:	e8 c6 03 00 00       	call   430 <printf>
    myMemory();
  6a:	e8 13 03 00 00       	call   382 <myMemory>

}
printf(1,"Ignore:%d",test);
  6f:	83 c4 0c             	add    $0xc,%esp
  72:	53                   	push   %ebx
  73:	68 54 07 00 00       	push   $0x754
  78:	6a 01                	push   $0x1
  7a:	e8 b1 03 00 00       	call   430 <printf>
exit();
  7f:	e8 5e 02 00 00       	call   2e2 <exit>
    myMemory();
    printf(1,"Ignore:%d",test);
    exit();
}
    ...
    wait();
  84:	e8 61 02 00 00       	call   2ea <wait>
    printf(1,"\n parent memory after child process \n");
  89:	50                   	push   %eax
  8a:	50                   	push   %eax
  8b:	68 a8 07 00 00       	push   $0x7a8
  90:	eb d1                	jmp    63 <main+0x63>
  92:	66 90                	xchg   %ax,%ax
  94:	66 90                	xchg   %ax,%ax
  96:	66 90                	xchg   %ax,%ax
  98:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3cf:	f7 f6                	div    %esi
 3d1:	0f b6 92 d8 07 00 00 	movzbl 0x7d8(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 548:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 54b:	b8 d0 07 00 00       	mov    $0x7d0,%eax
...
free(void *ap)
{
 ...
 627:	89 08                	mov    %ecx,(%eax)
  freep = p;
 629:	a3 74 0a 00 00       	mov    %eax,0xa74
}
 62e:	5b                   	pop    %ebx
 62f:	5e                   	pop    %esi
 630:	5f                   	pop    %edi
 ...
 64a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 64d:	a3 74 0a 00 00       	mov    %eax,0xa74
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 15 74 0a 00 00    	mov    0xa74,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 6bf:	76 3f                	jbe    700 <malloc+0xa0>
    ...
    if(p == freep)
 6c1:	39 05 74 0a 00 00    	cmp    %eax,0xa74
 ...
 6e6:	e8 e5 fe ff ff       	call   5d0 <free>
  return freep;
 6eb:	8b 15 74 0a 00 00    	mov    0xa74,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 724:	eb e9                	jmp    70f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 726:	c7 05 74 0a 00 00 78 	movl   $0xa78,0xa74
 72d:	0a 00 00 
 730:	c7 05 78 0a 00 00 78 	movl   $0xa78,0xa78
 737:	0a 00 00 
    base.s.size = 0;
 73a:	b8 78 0a 00 00       	mov    $0xa78,%eax
 73f:	c7 05 7c 0a 00 00 00 	movl   $0x0,0xa7c
 746:	00 00 00 
