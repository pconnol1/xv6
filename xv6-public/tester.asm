...
int *test = (int *)malloc(4096 * 8000);
  11:	68 00 00 f4 01       	push   $0x1f40000
  16:	e8 e5 05 00 00       	call   600 <malloc>
printf(1, "%d\n", test);
  1b:	83 c4 0c             	add    $0xc,%esp
  1e:	50                   	push   %eax
  1f:	68 f0 06 00 00       	push   $0x6f0
  24:	6a 01                	push   $0x1
  26:	e8 a5 03 00 00       	call   3d0 <printf>
myMemory();
  2b:	e8 f2 02 00 00       	call   322 <myMemory>
exit();
  30:	e8 4d 02 00 00       	call   282 <exit>
  35:	66 90                	xchg   %ax,%ax
  37:	66 90                	xchg   %ax,%ax
  39:	66 90                	xchg   %ax,%ax
  3b:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 36f:	f7 f6                	div    %esi
 371:	0f b6 92 fc 06 00 00 	movzbl 0x6fc(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 4e8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 4eb:	b8 f4 06 00 00       	mov    $0x6f4,%eax
...
free(void *ap)
{
 ...
 571:	a1 94 09 00 00       	mov    0x994,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 5c7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5c9:	a3 94 09 00 00       	mov    %eax,0x994
}
 5ce:	5b                   	pop    %ebx
 5cf:	5e                   	pop    %esi
 5d0:	5f                   	pop    %edi
 ...
 5ea:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 5ed:	a3 94 09 00 00       	mov    %eax,0x994
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 609:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 60c:	8b 15 94 09 00 00    	mov    0x994,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 65f:	76 3f                	jbe    6a0 <malloc+0xa0>
    ...
    if(p == freep)
 661:	39 05 94 09 00 00    	cmp    %eax,0x994
 ...
 686:	e8 e5 fe ff ff       	call   570 <free>
  return freep;
 68b:	8b 15 94 09 00 00    	mov    0x994,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 6ac:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 6af:	89 15 94 09 00 00    	mov    %edx,0x994
      return (void*)(p + 1);
 ...
 6c4:	eb e9                	jmp    6af <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6c6:	c7 05 94 09 00 00 98 	movl   $0x998,0x994
 6cd:	09 00 00 
 6d0:	c7 05 98 09 00 00 98 	movl   $0x998,0x998
 6d7:	09 00 00 
    base.s.size = 0;
 6da:	b8 98 09 00 00       	mov    $0x998,%eax
 6df:	c7 05 9c 09 00 00 00 	movl   $0x0,0x99c
 6e6:	00 00 00 
