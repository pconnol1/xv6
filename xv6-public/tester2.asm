...
_tester2:     file format elf32-i386
...
test = (int *)malloc(4096 * 8000);
  ...
  1b:	68 00 00 f4 01       	push   $0x1f40000
  20:	e8 0b 06 00 00       	call   630 <malloc>
printf(1, "%d\n", i);
...
printf(1, "%d\n", i);
  33:	6a 01                	push   $0x1
  35:	e8 c6 03 00 00       	call   400 <printf>
myMemory();
  3a:	e8 13 03 00 00       	call   352 <myMemory>
printf(1,"\n");
  3f:	58                   	pop    %eax
  40:	5a                   	pop    %edx
  41:	68 22 07 00 00       	push   $0x722
  46:	6a 01                	push   $0x1
...
main(int argc, char *argv[])
{
  ...
  50:	83 fb 0c             	cmp    $0xc,%ebx
  53:	75 c3                	jne    18 <main+0x18>
printf(1, "%d\n", i);
myMemory();
printf(1,"\n");
i++;
...
printf(1,"test variable (ignore) %d",test);
  ...
  58:	56                   	push   %esi
  59:	68 24 07 00 00       	push   $0x724
  5e:	6a 01                	push   $0x1
  60:	e8 9b 03 00 00       	call   400 <printf>
exit();
  65:	e8 48 02 00 00       	call   2b2 <exit>
  6a:	66 90                	xchg   %ax,%ax
  6c:	66 90                	xchg   %ax,%ax
  6e:	66 90                	xchg   %ax,%ax
...
putc(int fd, char c)
{
 ...
 518:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 51b:	b8 3e 07 00 00       	mov    $0x73e,%eax
