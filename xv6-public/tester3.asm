...
_tester3:     file format elf32-i386
...
test = (int *)malloc(4096 * 5000);
  ...
  1b:	68 00 80 38 01       	push   $0x1388000
  20:	e8 2b 06 00 00       	call   650 <malloc>
printf(1, "%d\n", i);
...
printf(1, "%d\n", i);
  ...
  30:	6a 01                	push   $0x1
  32:	e8 e9 03 00 00       	call   420 <printf>
myMemory();
  37:	e8 36 03 00 00       	call   372 <myMemory>
free(test);
  3c:	89 34 24             	mov    %esi,(%esp)
  3f:	e8 7c 05 00 00       	call   5c0 <free>
printf(1,"\n freed %d",i);
  44:	83 c4 0c             	add    $0xc,%esp
  47:	53                   	push   %ebx
  48:	68 44 07 00 00       	push   $0x744
myMemory();
printf(1,"\n");
i++;
...
myMemory();
  57:	e8 16 03 00 00       	call   372 <myMemory>
printf(1,"\n");
  5c:	58                   	pop    %eax
  5d:	5a                   	pop    %edx
  5e:	68 42 07 00 00       	push   $0x742
  63:	6a 01                	push   $0x1
  65:	e8 b6 03 00 00       	call   420 <printf>
int
main(int argc, char *argv[])
{
    int i=0;
  ...
  6d:	83 fb 0a             	cmp    $0xa,%ebx
  70:	75 a6                	jne    18 <main+0x18>
printf(1,"\n freed %d",i);
myMemory();
printf(1,"\n");
i++;
...
printf(1,"test variable (ignore) %d",test);
  ...
  75:	56                   	push   %esi
  76:	68 4f 07 00 00       	push   $0x74f
  7b:	6a 01                	push   $0x1
  7d:	e8 9e 03 00 00       	call   420 <printf>
exit();
  82:	e8 4b 02 00 00       	call   2d2 <exit>
  87:	66 90                	xchg   %ax,%ax
  89:	66 90                	xchg   %ax,%ax
  8b:	66 90                	xchg   %ax,%ax
  8d:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3bf:	f7 f6                	div    %esi
 3c1:	0f b6 92 70 07 00 00 	movzbl 0x770(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 538:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 53b:	b8 69 07 00 00       	mov    $0x769,%eax
...
malloc(uint nbytes)
{
 ...
 6be:	53                   	push   %ebx
 6bf:	e8 96 fc ff ff       	call   35a <sbrk>
  if(p == (char*)-1)
 ...
 6fc:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 6ff:	89 15 10 0a 00 00    	mov    %edx,0xa10
      return (void*)(p + 1);
 ...
 714:	eb e9                	jmp    6ff <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 716:	c7 05 10 0a 00 00 14 	movl   $0xa14,0xa10
 71d:	0a 00 00 
 720:	c7 05 14 0a 00 00 14 	movl   $0xa14,0xa14
 727:	0a 00 00 
    base.s.size = 0;
 72a:	b8 14 0a 00 00       	mov    $0xa14,%eax
 72f:	c7 05 18 0a 00 00 00 	movl   $0x0,0xa18
 736:	00 00 00 
